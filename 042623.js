...
// when the length of the circular arc A is given as the input. Return 
// the result rounded to two decimals.

// Graph

// Pic= square with an arc (A)

// Note: use the π value provided in your language (Math::PI, M_PI, math.
// pi, etc)
